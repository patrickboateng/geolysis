...
from geolab.bearing_capacity.spt_corrections import dilatancy_spt_correction, spt_n60
...
def test_spt_n60():
    assert spt_n60(15, 0.6, 1.0, 1.0, 0.85) == pytest.approx(12.75, ERROR_TOLERANCE)
